        ...
        <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-border-light dark:border-border-dark py-4 mb-6">
          <div className="flex items-center gap-8">
            ...
            <nav className="hidden md:flex items-center gap-6">
              ...
              <a href="https://wa.me/6285624228093?text=Halo%20Admin%20Nazhmi,%20saya%20ingin%20bertanya%20seputar%20SehatPedia" target="_blank" rel="noopener noreferrer" className="text-text-main-light dark:text-text-main-dark text-sm font-medium hover:text-primary transition-colors">Kontak</a>
            </nav>
          </div>
          <div className="flex items-center gap-4">
            <form onSubmit={handleSearch} className="hidden sm:flex items-center bg-surface-light dark:bg-surface-dark border border-border-light dark:border-border-dark rounded-full px-4 py-2">
              <span className="material-symbols-outlined text-text-muted-light dark:text-text-muted-dark mr-2 text-sm">search</span>
              <input 
                className="bg-transparent border-none outline-none text-sm text-text-main-light dark:text-text-main-dark placeholder-text-muted-light dark:placeholder-text-muted-dark w-32 lg:w-48 focus:ring-0 p-0" 
        ...
        <footer className="border-t border-border-light dark:border-border-dark py-8 mt-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              ...
              <a href="https://wa.me/6285624228093?text=Halo%20Admin%20Nazhmi,%20saya%20ingin%20bertanya%20seputar%20SehatPedia" target="_blank" rel="noopener noreferrer" className="text-sm text-text-muted-light dark:text-text-muted-dark hover:text-primary transition-colors">Kontak</a>
            </div>
