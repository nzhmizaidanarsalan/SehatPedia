  ...
  return (
    <main className="flex-1 flex flex-col gap-8 pb-12">
      <div className="flex items-center gap-4 border-b border-border-light dark:border-border-dark pb-6">
        ...
        <div>
          <h1 className="text-3xl font-bold text-secondary">Hasil Pencarian</h1>
          <p className="text-text-muted-light dark:text-text-muted-dark mt-1">
            Menampilkan hasil untuk: <span className="font-bold text-text-main-light dark:text-text-main-dark">"{query}"</span>
          </p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          <span className="material-symbols-outlined text-6xl text-text-muted-light mb-4">search_off</span>
          <h2 className="text-xl font-bold text-secondary mb-2">Tidak Ditemukan</h2>
          <p className="text-text-muted-light">Maaf, kami tidak menemukan artikel yang cocok dengan pencarian Anda.</p>
        </div>
      ) : (
